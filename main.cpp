...
{    
    ...
    textIntroNormal.SetTextContent("Du erwächst aus dem Dunkel. Deine Sensoren flackern, Systeme booten langsam hoch. Ein Labor einst hochmodern, jetzt eine verwüstete Ruine. Deckenpaneele hängen herab, Kabel baumeln wie verkohlte Adern, und der Staub vergangener Jahre liegt dick auf zerbrochenen Reagenzgläsern. Irgendwo tropft Wasser, ein monotoner Schlag gegen die Stille. Dein Speicher ist fragmentiert. Letzte aufgezeichnete Daten: Warnsignale, Evakuierungsalarme, Schreie. Dann  Nichts. Bis jetzt.\nWas tust du?");
    ...
    TextIntroItemCD41Umschauen.SetTextContent(" Jedoch siehst du auf ihm etwas reflektieren. Es ist eine CD in einer klarsicht Folie mit der aufschrift #41.");
    keineCD.SetTextContent("Du besitzt keine CD!\n");
    benutzeCD.SetTextContent("Du schiebst die CD in eines der passenden Laufwerke. Plötzlich blendet dich ein grelles Licht, und du verlierst die Kontrolle über deine künstlichen Sinne. Nach einiger Zeit kehren sie langsam zurück, und deine Umgebung kommt wieder ins Blickfeld. Du befindest dich wieder in dem Raum, in dem du die CD gefunden hast doch etwas ist anders. Die einst zerstörten Geräte sind nun makellos, als wären sie nie beschädigt worden. Die Wände wirken steril, fast klinisch sauber, als hätte sich der Raum selbst regeneriert. Dann tritt eine Person in dein Sichtfeld. Ihre Stimme ist ruhig, aber bestimmt: »Du wirst sicher verwirrt sein, doch das spielt keine Rolle. Deine Aufgabe ist klar: Starte die Simulation in Raum 102 neu dort ist etwas schiefgelaufen. Um diesen Raum zu verlassen, musst du die Sicherheitstür entsperren. Der Code lautet 4097. Viel Erfolg«.\n");
    SicherheitsTorZu.SetTextContent("Du versuchst durch das Sicherheitstor zu treten, dieser lässt sich aber auch mit aller mühe nicht öffnen. Eine Konsole neben dem Tor verlangt ein Code\n");
    SicherheitsTorOeffnen.SetTextContent("Du gibst den Code in die Konsole neben das Tor ein »4097«. Ein kleines piepen bestätigt deine Code eingabe und mit einem tiefen knurren öffnet sich das Tor\n");
    ...
    benutzeSD.SetTextContent("Wie bei der CD suchst du an deinem Körper eine passende Schnittstelle für die SD-Karte. Als du sie reinschriebst siehst du einen Techniker an dem Schaltschrank vor dir, er führt ein Zettel mit sich auf dem steht:\n \033[3;42;30mBlau \033[3;43;30mGelb \033[3;44;30mRot \033[3;45;30mWeiss\033[0m\t\t\n1 1 0 0\n Es dauerte nur einen Augenblick und befindest dich jetzt wieder in der Realität\n");

    //Flur
    WerkzeugsatzNichtHier.SetTextContent("Dein Werkzeugsatz kann hier nicht benutzt werden!\n");
    textFlurNormal.SetTextContent("Licht flackert in den kaputten Leuchten, wirft unstete Schatten an die Wände. Ein leichter, beißender Geruch nach verbranntem Plastik und Staub liegt in der Luft. Es ist, als wäre die Zeit hier stehengeblieben ein Ort, den die Welt längst vergessen hat.\n");
    textFlurUmschauen.SetTextContent("Aus dem Raum dem du getreten bist steht auf einem Schild  »Raum 101«. An einem Ende des Flures siehst du eine Konsole und im Flur befindet Sich ein weiters Tor mit einem Schild »Raum 102«. Am anderen Ende des Flures befindet sich ein Schaltschrank\n");
    ...
    falscherFarbCode.SetTextContent("Der angegebene Farbcode ist falsch. Bitte einen anderen eingeben!\n");
    richtigerFarbCode.SetTextContent("Der angegebene Farbcode ist richtig. Die Stromversorgung der Tür 102 wurde widerhergestellt!\n");
    ...
    //102
    betreten102.SetTextContent("In der Sekunde wo du den Raum betrittst verriegelt sich die Tür hinter dir und lässt dich nicht mehr entkommen. Der Raum ist makellos und zeigt keine Wunden der Zeit, in der mitte befindet sich ein großes Gerät was beinahe den ganzen Raum ausfültt an dem Fuß des Konstrukts findest du eine Konsole auf dieser steht:\nSIMULATION IST MISSLUNGEN UND FÜHRTE ZU EINER WEITEREN AUSLÖSCHUNG\nAUTOMATISCHER NEUSTART DER SIMULATION IST FEHLGESCHLAGEN\nROBOTER WURDE ENTSANDT ZUM MANUELLEN NEUSTART\n\nBESTÄTIGEN SIE DEN NEUSTART DER SIMULATION NR.572960 DURCH JEGLICHE EINGABE");
